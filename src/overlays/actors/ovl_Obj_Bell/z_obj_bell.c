...
s32 func_80A357A8(ObjBell* this, PlayState* play) {
    ...
    if (this->collider1.base.ocFlags1 & OC1_HIT) {
        ...
        if (ABS(temp_v1) < 0x3FFC) {
            if (this->unk_214 == 0) {
                if (temp_f0 > 0.18f) {
                    func_8002F71C(play, &this->dyna.actor, 8.0f * temp_f0, this->dyna.actor.yawTowardsPlayer,
                                  11.0f * temp_f0);
                    this->unk_214 = 30;
                }
            }
    ...
    if (this->collider2.base.acFlags & AC_HIT) {
        ...
        switch (this->dyna.actor.colChkInfo.damageEffect) {
            case 15:
                Audio_PlayActorSound2(&this->dyna.actor, NA_SE_EV_SHIP_BELL);
...
void ObjBell_InitDynaPoly(PlayState* play, DynaPolyActor* dynaActor, CollisionHeader* meshHeader) {
...
void ObjBell_Init(Actor* thisx, PlayState* play) {
    ...
    ObjBell_InitDynaPoly(play, &this->dyna, &object_f52_obj_Colheader_001BA8);
...
void ObjBell_Draw(Actor* thisx, PlayState* play) {
    ...
    GfxPrint_Printf(&printer, "%02x\n             %02x\n             %02x\n             %02x\n
                 %02x\n             %02x\n             %02x\n",
     this->unk_20C, this->unk_20E, this->unk_210, this->unk_212, this->unk_214, this->unk_21C, this->unk_220);
