...
/* 0x0003 */ DEFINE_ACTOR(Obj_Shutter, ACTOR_OBJ_SHUTTER, ACTOROVL_ALLOC_NORMAL, "obj_shutter") // CUSTOM
/* 0x0004 */ DEFINE_ACTOR(En_GirlA, ACTOR_EN_GIRLA, ACTOROVL_ALLOC_NORMAL, "En_GirlA")
/* 0x0005 */ DEFINE_ACTOR(Bg_Market_Step, ACTOR_BG_MARKET_STEP, ACTOROVL_ALLOC_NORMAL, "bg_market_step") // CUSTOM
/* 0x0006 */ DEFINE_ACTOR(Box_Warp, ACTOR_BOX_WARP, ACTOROVL_ALLOC_NORMAL, "Box_Warp") // CUSTOM
...
/* 0x0017 */ DEFINE_ACTOR(Obj_Bell, ACTOR_OBJ_BELL, ACTOROVL_ALLOC_NORMAL, "obj_bell") // CUSTOM
...
/* 0x001A */ DEFINE_ACTOR(En_Mkk, ACTOR_EN_MKK, ACTOROVL_ALLOC_NORMAL, "En_Mkk") // CUSTOM
